			...
			<div class="row">
                  <div class="col-lg-12">
                      <div class="panel panel-primary">
                          <div class="panel-heading">Tambah Data Profit Perbulan</div>
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" method="post" action="<?php echo site_url('profitbulanan/tambahProfitbulanan')?>">
                                      <div class="form-group">
                                          <label for="kd_profitbulanan" class="control-label col-lg-2">Kode</label>
                                          <div class="col-lg-10">
                                              <input class="form-control" name="kd_profitbulanan" type="text" value="<?php echo $kd_profitbulanan ?>" 
